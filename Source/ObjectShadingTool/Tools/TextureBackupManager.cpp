	...
	UMaterialInstanceConstant* Material)
{
	...
	if (bDoRestore)
	{
		...
		if (bDoPaint)
		{
			...
			{
				UE_LOG(LogShadingTool, Error, TEXT("%s: Failed cast to UMaterialInstance"), *FString(__FUNCTION__))
			}
		}
	}
	else
	{
		...
		if (bDoAdd)
		{
			...
			{
				UE_LOG(LogShadingTool, Error, TEXT("%s: Failed cast to UMaterialInstanceConstant"), *FString(__FUNCTION__))
			}
		}
		if (bDoPaint)
		{
			...
			{
				UE_LOG(LogShadingTool, Error, TEXT("%s: Failed cast to UMaterialInterface"), *FString(__FUNCTION__))
			}
		}
	}
}
	...
	UMaterialInstanceConstant* Material)
{
	...
	{
		UE_LOG(LogShadingTool, Warning, TEXT("%s: Actor expected but not found in OriginalActorDescriptors"),
	...
	for (UActorComponent* ActorComponent : ActorComponents)
	{
		...
		{
			UE_LOG(LogShadingTool, Error, TEXT("%s: Got null static mesh component"), *FString(__FUNCTION__))
			return;
		}
		...
		{
			UE_LOG(LogShadingTool, Warning, TEXT("%s: PrimitiveComponent expected but not found in OriginalActorDescriptors"),
				*FString(__FUNCTION__))
			return;
		}
		...
		{
			UE_LOG(LogShadingTool, Error, TEXT("%s: %d instead of %d actor's mesh component materials found"),
				*FString(__FUNCTION__),
